...
let nivelActual = 0
let estado = ""
// PANTALLA DE PERSONAJE: los dibujos que hizo Cris, uno por habilidad.
// Se muestra al elegir personaje, justo antes de cargar el nivel.
function mostrarFondoPersonaje () {
    if (personajeSeleccionado == "Ale") {
        scene.setBackgroundImage(img`
    ...
    888888888888888888888888888888888888888888888888888fffffffffff....ffffffffff888888888888888888888888888888888888888888888888888888888888888888888888888888888888
        `)
    } else if (personajeSeleccionado == "Cris") {
        scene.setBackgroundImage(img`
